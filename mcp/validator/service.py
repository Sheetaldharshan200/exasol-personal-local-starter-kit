            ...
            if detection.detected:
                ...
                findings.append(
                    Finding(
                        ...
                        message=f"{adapter.display_name()} was not auto-detected.",
                        scope={"client": adapter.adapter_id()},
                        evidence=detection.evidence,
                        recommended_action="Open the client once or provide an explicit config-path override before relying on discovery.",
                    )
                )

...
FROM STARTER_KIT.CUSTOMER c
JOIN STARTER_KIT.ORDERS o   ON o.O_CUSTKEY = c.C_CUSTKEY
JOIN STARTER_KIT.LINEITEM l ON l.L_ORDERKEY = o.O_ORDERKEY
...
FROM STARTER_KIT.PART p
JOIN STARTER_KIT.LINEITEM l ON l.L_PARTKEY = p.P_PARTKEY
...
FROM STARTER_KIT.CUSTOMER c
JOIN STARTER_KIT.NATION n ON n.N_NATIONKEY = c.C_NATIONKEY
JOIN STARTER_KIT.REGION r ON r.R_REGIONKEY = n.N_REGIONKEY
...
FROM STARTER_KIT.CUSTOMER c
WHERE c.C_ACCTBAL > 0
  AND NOT EXISTS (SELECT 1 FROM STARTER_KIT.ORDERS o WHERE o.O_CUSTKEY = c.C_CUSTKEY)
...
FROM STARTER_KIT.ORDERS o
JOIN STARTER_KIT.CUSTOMER c ON c.C_CUSTKEY = o.O_CUSTKEY
...
FROM STARTER_KIT.SUPPLIER s
JOIN STARTER_KIT.LINEITEM l ON l.L_SUPPKEY = s.S_SUPPKEY
...
FROM STARTER_KIT.PARTSUPP ps
JOIN STARTER_KIT.SUPPLIER s ON s.S_SUPPKEY = ps.PS_SUPPKEY
JOIN STARTER_KIT.NATION n   ON n.N_NATIONKEY = s.S_NATIONKEY
JOIN STARTER_KIT.REGION r   ON r.R_REGIONKEY = n.N_REGIONKEY
